...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$conn){
        ...
        $sql1 = "INSERT INTO `students` (`name`, `email`,`rollNo`,`department`,`mobileNo`, `cnicNo`, `postalAddress`, `dt`) VALUES ('$name', '$email', '$rollNo','$department','$telNo','$cnicNo','$postalA', current_timestamp())";
